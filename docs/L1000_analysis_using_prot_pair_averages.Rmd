...
names(rsq_dat_steiger_info)[7:8] <- c("Exposure_protein_ID","Exposure_protein_name")

rsq_dat_steiger_info <- merge(rsq_dat_steiger_info, protein_linker_file, by.x="id.outcome", by.y="protein_number")
names(rsq_dat_steiger_info)[9:10] <- c("Outcome_prtein_ID","Outcome_protein_name")


head(rsq_dat_steiger_info)
head(L1000_prot_pair_averages)
```
